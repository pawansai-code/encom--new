    ...
    <>
      {selectedChat ? (
          ...
          >
            ...
            {messages &&
              (!selectedChat.isGroupChat ? (
                ...
                <>
                  <Text bgGradient="linear(to-r, #7928CA, #FF0080)" bgClip="text">
              ...
              <InputGroup>
                <Input
                  ...
                  _focus={{
                    ...
                    boxShadow: "0 0 8px rgba(121, 40, 202, 0.4)"
                  }}
        ...
        <Box display="flex" alignItems="center" justifyContent="center" h="100%">
          <Text fontSize="3xl" pb={3} fontFamily="Inter" fontWeight="bold" opacity={0.6}>
